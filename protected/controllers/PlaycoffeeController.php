...
class PlaycoffeeController extends Controller {
    ...
    public function actionIndex() {
        ...
        $criteria->condition = (FunctionCommon::isPostFunction("coffee") && !FunctionCommon::isViewFunction("coffee")) ? "contributor_id=" . Yii::app()->session['id'] : "true";
        ...
        $model = Coffee::model()->findAll($criteria);

        $this->render('/play/coffee/index', array(
            'pages' => $pages,
            'model' => $model,
    ...
    public function actionRegist() {
        ...
        $this->render('/play/coffee/regist', $parmas);
    }
    ...
    public function actionRegistconfirm() {
        ...
        if (Yii::app()->request->isPostRequest) {
            ...
            if (!isset($_POST['regist']) || $_POST['regist'] != '1') {
                ...
                Upload_file_common_new::processAttachments($model, 'coffee', 1);
            }
            if ($model->validate()) {
                if (isset($_POST['regist']) && $_POST['regist'] == '1') {
                    ...
                    if ($model->save() == true) {
                        ...
                        if (FunctionCommon::isViewFunction("coffee") == false) {
                            ...
                            $this->redirect(array('playcoffee/index'));
                        }
                    }
                }
            } else {
                ...
                $this->redirect(array('playcoffee/regist'));
            }
        } else {
            $this->redirect(array('playcoffee/index'));
        }
        $this->render('/play/coffee/registconfirm', array('model' => $model));
    }
    ...
    public function actionDetail() {
        ...
        if (!empty($model->title)) {
            ...
            $this->render('/play/coffee/detail', array(
                'model' => $model
                    )
            );
        } else {
    ...
    public function filters() {
        $backCookie = Yii::app()->request->cookies->contains('coffee_regist_from') ? Yii::app()->request->cookies['coffee_regist_from']->value : '';
