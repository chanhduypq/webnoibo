...
class News extends CActiveRecord {
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            if (Yii::app()->request->cookies['file_news_regist_attachment1'] != NULL) {
                $this->attachment1 = Yii::app()->request->cookies['file_news_regist_attachment1']->value;
            } else {
                $this->attachment1 = '';
            }
            if (Yii::app()->request->cookies['file_news_regist_attachment2'] != NULL) {
                $this->attachment2 = Yii::app()->request->cookies['file_news_regist_attachment2']->value;
            } else {
                $this->attachment2 = '';
            }
            if (Yii::app()->request->cookies['file_news_regist_attachment3'] != NULL) {
                $this->attachment3 = Yii::app()->request->cookies['file_news_regist_attachment3']->value;
            } else {
                $this->attachment3 = '';
            }
            unset(Yii::app()->request->cookies['file_news_regist_attachment1']);
            unset(Yii::app()->request->cookies['file_news_regist_attachment2']);
            unset(Yii::app()->request->cookies['file_news_regist_attachment3']);
            unset(Yii::app()->request->cookies['file_news_regist_attachment1_thumnail']);
            unset(Yii::app()->request->cookies['file_news_regist_attachment2_thumnail']);
            unset(Yii::app()->request->cookies['file_news_regist_attachment3_thumnail']);
        } else {
            if (Yii::app()->request->cookies['file_news_edit_attachment1'] != NULL) {
                $this->attachment1 = Yii::app()->request->cookies['file_news_edit_attachment1']->value;
            }

            if (Yii::app()->request->cookies['file_news_edit_attachment2'] != NULL) {
                $this->attachment2 = Yii::app()->request->cookies['file_news_edit_attachment2']->value;
            }

            if (Yii::app()->request->cookies['file_news_edit_attachment3'] != NULL) {
                $this->attachment3 = Yii::app()->request->cookies['file_news_edit_attachment3']->value;
            }
            unset(Yii::app()->request->cookies['file_news_edit_attachment1']);
            unset(Yii::app()->request->cookies['file_news_edit_attachment2']);
            unset(Yii::app()->request->cookies['file_news_edit_attachment3']);
            unset(Yii::app()->request->cookies['file_news_edit_attachment1_thumnail']);
            unset(Yii::app()->request->cookies['file_news_edit_attachment2_thumnail']);
            unset(Yii::app()->request->cookies['file_news_edit_attachment3_thumnail']);

            /**
             * process attachment1
             */
            $attachment1 = Upload_file_common::getAttachmentById($this->id, 1, 'news');
             ...
             * process attachment2
             */
            $attachment2 = Upload_file_common::getAttachmentById($this->id, 2, 'news');
             ...
             * process attachment3
             */
            $attachment3 = Upload_file_common::getAttachmentById($this->id, 3, 'news');
    ...
    public function afterSave() {
        $count=Yii::app()->db->createCommand()
                    ...
                    ->from("news_read")
                    ->where("user_id=".Yii::app()->request->cookies['id']->value." and news_id=".$this->id)
                    ->queryScalar();
            if($count=='0'){
                Yii::app()->db->createCommand("insert into news_read values (".$this->id.",".Yii::app()->request->cookies['id']->value.")")->execute();
            }
            $data = array(
            'type' => 2,
            'table_name' => 'news',
