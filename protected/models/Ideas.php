...
class Ideas extends CActiveRecord {
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            ...
            unset(Yii::app()->request->cookies['file_ideas_regist_attachment1_thumnail']);
            unset(Yii::app()->request->cookies['file_ideas_regist_attachment2_thumnail']);
            unset(Yii::app()->request->cookies['file_ideas_regist_attachment3_thumnail']);
        } else {
            ...
            unset(Yii::app()->request->cookies['file_ideas_edit_attachment1_thumnail']);
            unset(Yii::app()->request->cookies['file_ideas_edit_attachment2_thumnail']);
            unset(Yii::app()->request->cookies['file_ideas_edit_attachment3_thumnail']);
    ...
    public function saveIdeas_comment($ideas_comment) {
        ...
        $ideas_comment->contributor_id = Yii::app()->request->cookies['id']->value;
