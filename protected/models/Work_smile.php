...
class Work_smile extends CActiveRecord {
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            if (Yii::app()->request->cookies['file_work_smile_regist_attachment1'] != NULL) {
                $this->attachment1 = Yii::app()->request->cookies['file_work_smile_regist_attachment1']->value;
            } else {
                $this->attachment1 = '';
            }
            
            unset(Yii::app()->request->cookies['file_work_smile_regist_attachment1']);
            unset(Yii::app()->request->cookies['file_work_smile_regist_attachment1_thumnail']);
            
        } else {
            if (Yii::app()->request->cookies['file_work_smile_edit_attachment1'] != NULL) {
                $this->attachment1 = Yii::app()->request->cookies['file_work_smile_edit_attachment1']->value;
            }

            
            unset(Yii::app()->request->cookies['file_work_smile_edit_attachment1']);
            unset(Yii::app()->request->cookies['file_work_smile_edit_attachment1_thumnail']);
            

            /**
             * process attachment1
             */
            $attachment1 = Upload_file_common::getAttachmentById($this->id, 1, 'work_smile');
