...
<div class="wrap admin secondary coffee">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_DETAIL_IN_LINK_BACK_DIV,"link"=>'/adminnews_cv/detail') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?> 
            <div class="mainBox detail">
                ...
                <?php 
					...
					?>
                <span><a href="<?php echo Yii::app()->request->baseUrl; ?>/adminnews_cv/<?php echo $page?>" class="btn btn-important"><i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?></a></span>        
                <span><a href="<?php echo Yii::app()->request->baseUrl; ?>/adminnews_cv/edit/?id=<?php echo $model->id; ?>" class="btn btn-work"><i class="icon-pencil icon-white"></i><?php echo Config::TEXT_FOR_EDIT_IN_PAGE_DETAIL;?></a></span>
                </div>
                <div class="box">
					...
					<div class="photo">
                        <div class="imgbox">                            
                            	  <?php 
								   if(trim($attachment1)!="")
								   {	
										 FunctionCommon::echoOldFile($attachment1_ext, 1, $model,"adminnews_cv",Yii::app()->request->baseUrl);
                                   }
                                   ?>
                        </div>
                        <div class="imgbox">
								   ...
								   if(trim($attachment2)!="")
								   {
								 		  FunctionCommon::echoOldFile($attachment2_ext, 2, $model,"adminnews_cv",Yii::app()->request->baseUrl);	     
                                   }
                                   ?>
                        </div>
                        <div class="imgbox">
								   ...
								   if(trim($attachment3)!="")
								   {
								 		  FunctionCommon::echoOldFile($attachment3_ext, 3, $model,"adminnews_cv",Yii::app()->request->baseUrl);	
                                   }
                                   ?>
                        </div>
                    </div>                   
