...
<?php
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/adminhobby_itd/regist') ;        
...
<script type="text/javascript">  
    ...
    if(options.length==1&&$("#Hobby_itd_unit_id").val()==""){
        ...
        $("#Hobby_itd_unit_id").change(function() {
           ...
           $("#hobby_itd_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminhobby_itd/registconfirm/');          
          
          
           unit_id=getCookie("hobby_itd_regist_unit_id");     
           if(unit_id!=null&&unit_id!="null"){
            ...
            unit_id=str_id[0];
            position_id=str_id[1];
               user_id=getCookie("hobby_itd_regist_user_id"); 
               $.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminhobby_itd/getusers/?unit_id="+unit_id+"&position_id="+position_id,    				
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminhobby_itd/regist/",    
				...
				success: function(msg){	                        					  		
					  	...
					  	if(msg!='[]'){
                                                ...
                                                setCookie("hobby_itd_regist_unit_id",$("#Hobby_itd_unit_id").val());
                                                setCookie("hobby_itd_regist_user_id",$("#Hobby_itd_user_id").val());
