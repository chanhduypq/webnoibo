...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/adminhobby_itd/registconfirm') ;        
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $('button#back').click(function(){         
            window.location="<?php echo Yii::app()->baseUrl;?>/adminhobby_itd/regist/";
        }); 
    });
</script>
