...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_DETAIL_IN_LINK_BACK_DIV,"link"=>'/adminwork_smile/detail') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?> 
            <div class="mainBox detail">
            	<div class="pageTtl">
					...
					<span>
						<a href="<?php echo Yii::app()->request->baseUrl; ?>/adminwork_smile/edit/?id=<?php echo $model->id;?>" class="btn btn-work">
                ...
                <div class="box">
				    ...
				    <div class="photo">
						<div class="imgbox">                            
							...
							<?php FunctionCommon::echoOldFile($attachment1_ext, 1, $model,"adminwork_smile",Yii::app()->request->baseUrl,true);	 ?>
							<?php endif; ?>
						</div>
