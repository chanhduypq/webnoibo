...
<div class="wrap secondary admin">
        ...
        <div class="contents detail">
        	...
        	$home_link='/admin';
        $link_array=array();
        $link_array[]=array("text"=>"Bộ phận","link"=>'/adminuser') ; 
        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?> 
            <div class="mainBox">
                ...
                <span><a class="btn btn-important" href="<?php echo Yii::app()->baseUrl;?>/adminpost/index?page=<?php echo Yii::app()->request->cookies['page']->value; ?>"><i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?></a></span>
                <span><a class="btn btn-work" href="<?php echo Yii::app()->baseUrl;?>/adminpost/edit/?id=<?php echo $model->id ;?>"><i class="icon-pencil icon-white"></i><?php echo Config::TEXT_FOR_EDIT_IN_PAGE_DETAIL;?></a></span></div>
                <div class="box">
                ...
                <div class="baseDetailBox">
                    ...
                    <div class="textBox mt15 clearfix">
                        ...
                        <div class="field affili_post">
                            ...
                            <div class="data">
								<p>
									<?php echo htmlspecialchars($model->post_name);?>
								</p>
							</div>
                        </div>
                        ...
                        <div class="imgbox">                            
                            	  <?php 
								   if(trim($attachment1)!="")
								   {	
										 FunctionCommon::echoOldFile($attachment1_ext, 1, $model,"adminpost",Yii::app()->request->baseUrl);
                                   }
                                   ?>
                        </div>
                        <div class="imgbox">
								   ...
								   if(trim($attachment2)!="")
								   {
								 		  FunctionCommon::echoOldFile($attachment2_ext, 2, $model,"adminpost",Yii::app()->request->baseUrl);	     
                                   }
                                   ?>
                        </div>
                        <div class="imgbox">
								   ...
								   if(trim($attachment3)!="")
								   {
								 		  FunctionCommon::echoOldFile($attachment3_ext, 3, $model,"adminpost",Yii::app()->request->baseUrl);	
                                   }
                                   ?>
                        </div>
                    </div>
