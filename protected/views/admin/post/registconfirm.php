...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/adminpost/registconfirm') ; 
            ...
            <div class="mainBox">
                ...
                <div class="box">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        'id' => 'post_form',
                        'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/adminpost/registconfirm'),
                    ));
                    ?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                                 <?php                    
                                    ...
                                    $attachements->registConfirm11($model, $form,'adminpost',Yii::app()->request->baseUrl);
									$this->endWidget();
                           		 ?>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $(window).on('beforeunload', function() {
            setCookie("post_regist_from", "confirm");
        ...
        $('button#back').click(function() {
            ...
            setCookie("post_regist_from", "confirm");
             ...
             window.location="<?php echo Yii::app()->baseUrl;?>/adminpost/regist";
        });
        $('a').click(function() {
