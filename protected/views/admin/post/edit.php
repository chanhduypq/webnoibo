...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminpost/edit') ; 
                ...
                <div class="box">
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
							...
							$attachements->edit11($model, $form,'adminpost',$attachment1_error,$attachment2_error,$attachment3_error,Yii::app()->request->baseUrl);                        
							$this->endWidget();
                           		 ?>
...
<script type="text/javascript"> 
        ...
        jQuery(function($){
         ...
         $("#post_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminpost/editconfirm/');        
            
			//check back browser 
		   
		   
		   
		   post_name=getCookie("post_edit_post_name");
           ...
           unit_id=getCookie("post_edit_unit_id");
           ...
           $("#Post_unit_id").val(unit_id);
		    ...
		    attachment1_checkbox_for_deleting=getCookie("post_edit_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("post_edit_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("post_edit_attachment3_checkbox_for_deleting");
           ...
           $('button[type="submit"]').click(function(){ 
            ...
            deleteCookies("post_edit_from");
			
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminpost/edit/?id=<?php echo $model->id?>",    
				...
				{	     
					  ...
					  {   
                           ...
                           setCookie("post_edit_post_name",$("#Post_post_name").val());
                          
                           
						  setCookie("post_edit_unit_id",$("#Post_unit_id").val());
						   
                                                               
							if($("#Post_attachment1_checkbox_for_deleting").is(':checked')){
                                                           
								setCookie("post_edit_attachment1_checkbox_for_deleting",'1');
							}
							else{
								setCookie("post_edit_attachment1_checkbox_for_deleting",'0');
							}
							if($("#Post_attachment2_checkbox_for_deleting").is(':checked')){
								setCookie("post_edit_attachment2_checkbox_for_deleting",'1');
							}
							else{
								setCookie("post_edit_attachment2_checkbox_for_deleting",'0');
							}
							if($("#Post_attachment3_checkbox_for_deleting").is(':checked')){
								setCookie("post_edit_attachment3_checkbox_for_deleting",'1');
							}
							else{
								setCookie("post_edit_attachment3_checkbox_for_deleting",'0');
							}
