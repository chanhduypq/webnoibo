...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/admincontribute/editconfirm') ; 
            ...
            <div class="mainBox detail">
                ...
                <div class="box">
						...
						$form = $this->beginWidget('CActiveForm', array(
							'id' => 'contribute_form',
							'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/admincontribute/editconfirm'),
								));
						?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->editConfirm11($model, $form,'admincontribute',Yii::app()->request->baseUrl);
                            $this->endWidget();
                            ?>
                        </div>
                    </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) {  
        ...
        $(window).on('beforeunload', function(){
            setCookie("contribute_edit_from","confirm");            
        }); 
        $('button#submit').click(function(){  
            deleteCookies("contribute_edit_from");
            jQuery("input#edit").val('1');            
            jQuery("form#contribute_form").submit();
        });
        $('button#back').click(function(){ 
            setCookie("contribute_edit_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/admincontribute/edit/?id=<?php echo $model->id;?>";
        });
        $('a').click(function(){  
            if($(this).attr('id')==undefined||$(this).attr('id')=='bttop'){
                return;
            }
			 window.location="<?php echo Yii::app()->baseUrl;?>/admincontribute/download/?file_name="+$(this).attr('id');
        });
       
	    
        setCookie("contribute_edit_title",$("#Contribute_title").val());
        setCookie("contribute_edit_content",$("#Contribute_content").val());
        setCookie("contribute_edit_attachment1_checkbox_for_deleting",$("#Contribute_attachment1_checkbox_for_deleting").val());
        setCookie("contribute_edit_attachment2_checkbox_for_deleting",$("#Contribute_attachment2_checkbox_for_deleting").val());
        setCookie("contribute_edit_attachment3_checkbox_for_deleting",$("#Contribute_attachment3_checkbox_for_deleting").val());        
        $("body").attr('id','admin');         
    });
</script>