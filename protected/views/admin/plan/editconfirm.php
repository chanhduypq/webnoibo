...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminplan/editconfirm') ; 
            ...
            <div class="mainBox detail">
                ...
                <div class="box">
						...
						$form = $this->beginWidget('CActiveForm', array(
							'id' => 'plan_form',
							'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/adminplan/editconfirm'),
								));
						?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->editConfirm11($model, $form,'adminplan',Yii::app()->request->baseUrl);
                            $this->endWidget();
                            ?>
                        </div>
                    </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) {  
        ...
        $(window).on('beforeunload', function(){
            setCookie("plan_edit_from","confirm");            
        }); 
        ...
        $('button#back').click(function(){ 
            setCookie("plan_edit_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/adminplan/edit/?id=<?php echo $model->id;?>";
        });
        $('a').click(function(){  
            if($(this).attr('id')==undefined||$(this).attr('id')=='bttop'){
                return;
            }
			 window.location="<?php echo Yii::app()->baseUrl;?>/adminplan/download/?file_name="+$(this).attr('id');
        });
       
	    
        setCookie("plan_edit_title",$("#Plan_title").val());
        setCookie("plan_edit_content",$("#Plan_content").val());
        setCookie("plan_edit_attachment1_checkbox_for_deleting",$("#Plan_attachment1_checkbox_for_deleting").val());
        setCookie("plan_edit_attachment2_checkbox_for_deleting",$("#Plan_attachment2_checkbox_for_deleting").val());
        setCookie("plan_edit_attachment3_checkbox_for_deleting",$("#Plan_attachment3_checkbox_for_deleting").val());        
        $("body").attr('id','admin');         
    });
</script>