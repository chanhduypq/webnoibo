...
<div class="wrapper secondary admin">
        ...
        <div class="contents edit">
        	...
        	$home_link='/admin';
        $link_array=array();
        $link_array[]=array("text"=>"Mục tiêu và hành động","link"=>'/adminplan') ; 
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminplan/edit') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?> 
            <div class="mainBox detail">
                ...
                <?php 
					...
					?>
                <span><a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminplan/<?php echo $page;?>"><i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?></a></span>
                </div>
                <div class="box">
                <?php
                ...
                <div class="cnt-box">
                  ...
                  <div class="field attachements">
                        ...
                        $attachements->edit11($model, $form,'adminplan',$attachment1_error,$attachment2_error,$attachment3_error,Yii::app()->request->baseUrl);
                        $this->endWidget();
                        ?>
...
function checkId()
{
        ...
        type: "POST", 
                async:true,
                url: "<?php echo Yii::app()->baseUrl;?>/adminplan/checkId/",    
                data:{id:"<?php echo $model->id;?>",table:"plan"},
                success: function(msg){	
            
                        
                        if(msg=='0'){ 
                                window.location='<?php echo Yii::app()->baseUrl;?>/adminplan';
                        }
                }
        });
}
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#plan_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminplan/editconfirm/');   
		   
		 type=getCookie("plan_edit_icon");
		if(type!=null && type !="null")
		{
           ...
           title=getCookie("plan_edit_title");
           ...
           content=getCookie("plan_edit_content");
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Plan_content").val(content1);
           }   
           attachment1_checkbox_for_deleting=getCookie("plan_edit_attachment1_checkbox_for_deleting");
           if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
               if(attachment1_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Plan_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Plan_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Plan_attachment1_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment2_checkbox_for_deleting=getCookie("plan_edit_attachment2_checkbox_for_deleting");
           if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
               if(attachment2_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Plan_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Plan_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Plan_attachment2_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment3_checkbox_for_deleting=getCookie("plan_edit_attachment3_checkbox_for_deleting");
           if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
               if(attachment3_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Plan_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Plan_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Plan_attachment3_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           setCookie("plan_edit_title",$("#Plan_title").val());
           setCookie("plan_edit_content",content);

           $("body").attr('id','admin');     
           $('button[type="submit"]').click(function(){  
            no=2;            
            deleteCookies("plan_edit_from");  
            checkId();
			$.ajax({ 
                			
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminplan/edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	                        
					  ...
					  jQuery('#Plan_content').prev().remove();                                       					
					  	...
					  	if(msg!='[]'|checkFile()==false){
                                            ...
                                            {
                                                    setCookie("plan_edit_icon",'1');
                                            }
                                            if ($("#rdIcon2").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'2');
                                            }
                                            if ($("#rdIcon3").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'3');
                                            }
                                            if ($("#rdIcon4").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'4');
                                            }
                                            if ($("#rdIcon5").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'5');
                                            }
                                            if ($("#rdIcon6").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'6');
                                            }
                                            if ($("#rdIcon7").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'7');
                                            }
                                            if ($("#rdIcon8").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'8');
                                            }
                                            if ($("#rdIcon9").is(":checked"))
                                            {
                                                    setCookie("plan_edit_icon",'9');
                                            }
											
                                            setCookie("plan_edit_title",$("#Plan_title").val());
                                            val=$("#Plan_content").val();
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("plan_edit_content",val);
                                            if($("#Plan_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("plan_edit_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("plan_edit_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Plan_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("plan_edit_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("plan_edit_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Plan_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("plan_edit_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("plan_edit_attachment3_checkbox_for_deleting",'0');
                                                }
