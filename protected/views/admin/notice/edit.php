...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminnotice/edit') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?> 
            <div class="mainBox detail">
                ...
                <?php 
					...
					?>
                <span><a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminnotice/<?php echo $page;?>"><i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?></a></span>
                </div>
                <div class="box">
                <?php
                ...
                <div class="cnt-box">
                  ...
                  <div class="field attachements">
                        ...
                        $attachements->edit11($model, $form,'adminnotice',$attachment1_error,$attachment2_error,$attachment3_error,Yii::app()->request->baseUrl);
                        $this->endWidget();
                        ?>
...
function checkId()
{
        ...
        type: "POST", 
                async:true,
                url: "<?php echo Yii::app()->baseUrl;?>/adminnotice/checkId/",    
                data:{id:"<?php echo $model->id;?>",table:"notice"},
                success: function(msg){	
            
                        
                        if(msg=='0'){ 
                                window.location='<?php echo Yii::app()->baseUrl;?>/adminnotice';
                        }
                }
        });
}
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#notice_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminnotice/editconfirm/');   
		   
		 type=getCookie("notice_edit_icon");
		if(type!=null && type !="null")
		{
           ...
           title=getCookie("notice_edit_title");
           ...
           content=getCookie("notice_edit_content");
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Notice_content").val(content1);
           }   
           attachment1_checkbox_for_deleting=getCookie("notice_edit_attachment1_checkbox_for_deleting");
           if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
               if(attachment1_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Notice_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Notice_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Notice_attachment1_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment2_checkbox_for_deleting=getCookie("notice_edit_attachment2_checkbox_for_deleting");
           if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
               if(attachment2_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Notice_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Notice_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Notice_attachment2_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment3_checkbox_for_deleting=getCookie("notice_edit_attachment3_checkbox_for_deleting");
           if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
               if(attachment3_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Notice_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Notice_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Notice_attachment3_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           setCookie("notice_edit_content",content);
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({ 
				...
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminnotice/edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	                        
					  ...
					  jQuery('#Notice_content').prev().remove();                                       					
					  	...
					  	if(msg!='[]'|checkFile()==false){
                                            ...
                                            {
                                                    setCookie("notice_edit_icon",'1');
                                            }
                                            if ($("#rdIcon2").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'2');
                                            }
                                            if ($("#rdIcon3").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'3');
                                            }
                                            if ($("#rdIcon4").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'4');
                                            }
                                            if ($("#rdIcon5").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'5');
                                            }
                                            if ($("#rdIcon6").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'6');
                                            }
                                            if ($("#rdIcon7").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'7');
                                            }
                                            if ($("#rdIcon8").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'8');
                                            }
                                            if ($("#rdIcon9").is(":checked"))
                                            {
                                                    setCookie("notice_edit_icon",'9');
                                            }
											
                                            setCookie("notice_edit_title",$("#Notice_title").val());
                                            val=$("#Notice_content").val();
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("notice_edit_content",val);
                                            if($("#Notice_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("notice_edit_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("notice_edit_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Notice_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("notice_edit_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("notice_edit_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Notice_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("notice_edit_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("notice_edit_attachment3_checkbox_for_deleting",'0');
                                                }
