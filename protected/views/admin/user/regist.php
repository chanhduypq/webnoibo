...
function checkFile(){
    ...
    if(options.length==1&&$("#User_division").val()==""){
...
$('input#User_photo_checkbox_for_deleting').click (function (){                  
		...
		//begin 01/11/2013
		division=getCookie("user_regist_division");
	   ...
	   if(division!=null&&division!="null"){
           ...
           position=getCookie("user_regist_position");
           $.ajax({    
				type: "POST", 
				async:true,
       ...
       chuc_vu=getCookie("user_regist_chuc_vu");
                    ...
                    if (msg != '[]'|(date!=""&&(date.length<4||date[0]=='0'))|checkFile()==false) {
                         ...
                         */
                         ...
                         setCookie("user_regist_employee_number",$("#User_employee_number").val());
						   ...
						   setCookie("user_regist_division",$("#User_division").val());
						   setCookie("user_regist_position",$("#User_position").val());
                                                   setCookie("user_regist_chuc_vu",$("#User_chuc_vu").val());
...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/adminuser/regist') ;        
                ...
                <div class="box">
                   ...
                   <input type="hidden" name="post_name" id="post_name"/>
                                ...
                                <div class="building_photo">
                                    ...
                                    <?php
                                     $attachement4 = $this->beginWidget('ext.helpers.Form_new');
                                        $attachement4->regist14($model, $form,$attachment4_error,'adminuser',Yii::app()->request->baseUrl);
                                        $this->endWidget();
                                    ?>   
                                </div>
                    ...
                    <div class="form-last-btn">
                        <p class="btn80">
                            <button class="btn btn-important" type="submit" id="next"><i class="icon-chevron-right icon-white">&#12288;</i> <?php echo Config::TEXT_FOR_NEXT_IN_PAGE_REGIST;?></button>
                        </p>
                    </div>
