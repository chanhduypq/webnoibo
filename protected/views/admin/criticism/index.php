            ...
            <div class="mainBox detail">
                ...
                <table width="724" border="0" class="table list font14">
                    ...
                    <?php
						...
						{
							foreach ($ide as $criticism) 
							{
                    ?>      
                    <tr>
                        <td class="td-date alnC txtRed postsDate"><?php echo FunctionCommon::formatDate($criticism['created_date']); ?></td>
                        <td class="td-date alnC txtRed updateDate"><?php echo FunctionCommon::formatDate($criticism['last_updated_date']); ?></td>
                        <td class="td-text">
                        <p class="text">
                        ...
                        <td class="td-edit">
                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/admincriticism/edit/?id=<?php echo $criticism['id']; ?>" class="btn btn-work"><?php echo Config::TEXT_FOR_EDIT_IN_PAGE_ADMIN_INDEX;?></a>
                        
                        <a onclick="if(confirm('<?php echo Config::TEXT_FOR_CONFIRM_DELETE;?>')==true) window.location='<?php echo Yii::app()->request->baseUrl; ?>/admincriticism/delete/?id=<?php echo $criticism['id']; ?>';" href="#" class="btn btn-correct"><?php echo Config::TEXT_FOR_DELETE_IN_PAGE_ADMIN_INDEX;?></a></td>
                    </tr>
                   <?php
							}
						}
