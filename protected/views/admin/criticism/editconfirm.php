...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/admincriticism/editconfirm') ; 
                ...
                <div class="box">
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->editConfirm11($model, $form,'admincriticism',Yii::app()->request->baseUrl);
                            $this->endWidget();
                            ?>
                        </div>
                    </div><!-- /cnt-box -->	
    ...
    jQuery(function($) {  
        ...
        $('a').click(function(){  
            if($(this).attr('id')==undefined||$(this).attr('id')=='bttop'){
			 ...
			 window.location="<?php echo Yii::app()->baseUrl;?>/admincriticism/download/?file_name="+$(this).attr('id');
        });
