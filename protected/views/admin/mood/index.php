        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>
            <div class="mainBox detail">
            	<div class="pageTtl"><h2></h2>                    
                    <a class="btn btn-important" href="<?php echo Yii::app()->baseUrl;?>/adminmood/regist"><i class="icon-pencil icon-white"></i> <?php echo Config::TEXT_FOR_ADD_IN_PAGE_INDEX;?></a>                    
            	</div>
                <div class="box">
                ...
                <table width="724" border="0" class="table list font14">
                    ...
                    if(isset($moods)&&is_array($moods)&&count($moods)>0){
                        foreach ($moods as $mood){
	                        ...
	                        <td class="td-edit"><a class="btn btn-work" href="<?php echo Yii::app()->baseUrl; ?>/adminmood/edit/?id=<?php echo $mood['id'];?>"><?php echo Config::TEXT_FOR_EDIT_IN_PAGE_ADMIN_INDEX;?></a><a onclick="if(confirm('<?php echo Config::TEXT_FOR_CONFIRM_DELETE;?>')==true) window.location='<?php echo Yii::app()->request->baseUrl; ?>/adminmood/delete/?id=<?php echo $mood['id']; ?>'" href="#" class="btn btn-correct"><?php echo Config::TEXT_FOR_DELETE_IN_PAGE_ADMIN_INDEX;?></a></td>
	                    </tr>
