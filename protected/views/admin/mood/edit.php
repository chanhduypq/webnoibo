...
<?php
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminmood/edit') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>            
            <div class="mainBox detail">
            	<div class="pageTtl">
					...
					?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminmood/<?php echo $page;?>">
...
<script type="text/javascript">  
        jQuery(function($){ 
           ...
           $("#mood_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminmood/editconfirm/');          
           name=getCookie("mood_edit_name");
           ...
           $('button[type="submit"]').click(function(){  
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminmood/edit/?id=<?php echo $model->id;?>",    
