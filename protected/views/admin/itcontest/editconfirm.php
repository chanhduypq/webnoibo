...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminitcontest/editconfirm') ; 
            ...
            <div class="mainBox detail">
                ...
                <div class="box">
						...
						$form = $this->beginWidget('CActiveForm', array(
							'id' => 'itcontest_form',
							'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/adminitcontest/editconfirm'),
								));
						?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->editConfirm11($model, $form,'adminitcontest',Yii::app()->request->baseUrl);
                            $this->endWidget();
                            ?>
                        </div>
                    </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) {  
        ...
        $(window).on('beforeunload', function(){
            setCookie("itcontest_edit_from","confirm");            
        }); 
        $('button#submit').click(function(){  
            deleteCookies("itcontest_edit_from");
            jQuery("input#edit").val('1');            
            jQuery("form#itcontest_form").submit();
        });
        $('button#back').click(function(){ 
            setCookie("itcontest_edit_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/adminitcontest/edit/?id=<?php echo $model->id;?>";
        });
        $('a').click(function(){  
            if($(this).attr('id')==undefined||$(this).attr('id')=='bttop'){
                return;
            }
			 window.location="<?php echo Yii::app()->baseUrl;?>/adminitcontest/download/?file_name="+$(this).attr('id');
        });
       
	    
        setCookie("itcontest_edit_title",$("#Itcontest_title").val());
        setCookie("itcontest_edit_content",$("#Itcontest_content").val());
        setCookie("itcontest_edit_attachment1_checkbox_for_deleting",$("#Itcontest_attachment1_checkbox_for_deleting").val());
        setCookie("itcontest_edit_attachment2_checkbox_for_deleting",$("#Itcontest_attachment2_checkbox_for_deleting").val());
        setCookie("itcontest_edit_attachment3_checkbox_for_deleting",$("#Itcontest_attachment3_checkbox_for_deleting").val());        
        $("body").attr('id','admin');         
    });
</script>