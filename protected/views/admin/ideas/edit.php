...
<div class="wrapper secondary admin">
        ...
        <div class="contents edit">
        	...
        	$home_link='/admin';
        $link_array=array();
        $link_array[]=array("text"=>"Ý tưởng mới","link"=>'/adminideas') ; 
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminideas/edit') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?> 
            <div class="mainBox detail">
                ...
                <?php 
					...
					?>
                <span><a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminideas/<?php echo $page;?>"><i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?></a></span>
                </div>
                <div class="box">
                <?php
                ...
                <div class="cnt-box">
                  ...
                  <div class="field attachements">
                        ...
                        $attachements->edit11($model, $form,'adminideas',$attachment1_error,$attachment2_error,$attachment3_error,Yii::app()->request->baseUrl);
                        $this->endWidget();
                        ?>
...
function checkId()
{
        ...
        type: "POST", 
                async:true,
                url: "<?php echo Yii::app()->baseUrl;?>/adminideas/checkId/",    
                data:{id:"<?php echo $model->id;?>",table:"ideas"},
                success: function(msg){	
            
                        
                        if(msg=='0'){ 
                                window.location='<?php echo Yii::app()->baseUrl;?>/adminideas';
                        }
                }
        });
}
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#ideas_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminideas/editconfirm/');   
		   
		   
		                    
           title=getCookie("ideas_edit_title");
           ...
           content=getCookie("ideas_edit_content");
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Ideas_content").val(content1);
           }   
           attachment1_checkbox_for_deleting=getCookie("ideas_edit_attachment1_checkbox_for_deleting");
           if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
               if(attachment1_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Ideas_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Ideas_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Ideas_attachment1_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment2_checkbox_for_deleting=getCookie("ideas_edit_attachment2_checkbox_for_deleting");
           if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
               if(attachment2_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Ideas_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Ideas_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Ideas_attachment2_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment3_checkbox_for_deleting=getCookie("ideas_edit_attachment3_checkbox_for_deleting");
           if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
               if(attachment3_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Ideas_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Ideas_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Ideas_attachment3_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           setCookie("ideas_edit_content",content);
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({ 
				...
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminideas/edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	                        
					  ...
					  jQuery('#Ideas_content').prev().remove();                                       					
					  	if(msg!='[]'|checkFile()==false){
                                            ...
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("ideas_edit_content",val);
                                            if($("#Ideas_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("ideas_edit_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("ideas_edit_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Ideas_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("ideas_edit_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("ideas_edit_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Ideas_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("ideas_edit_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("ideas_edit_attachment3_checkbox_for_deleting",'0');
                                                }
