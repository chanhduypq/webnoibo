...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminnews/editconfirm') ; 
            ...
            <div class="mainBox detail">
                ...
                <div class="box">
						...
						$form = $this->beginWidget('CActiveForm', array(
							'id' => 'news_form',
							'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/adminnews/editconfirm'),
								));
						?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->editConfirm11($model, $form,'adminnews',Yii::app()->request->baseUrl);
                            $this->endWidget();
                            ?>
                        </div>
                    </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) {  
        ...
        $(window).on('beforeunload', function(){
            setCookie("news_edit_from","confirm");            
        }); 
        ...
        $('button#back').click(function(){ 
            setCookie("news_edit_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/adminnews/edit/?id=<?php echo $model->id;?>";
        });
        $('a').click(function(){  
            if($(this).attr('id')==undefined||$(this).attr('id')=='bttop'){
                return;
            }
			 window.location="<?php echo Yii::app()->baseUrl;?>/adminnews/download/?file_name="+$(this).attr('id');
        });
       
	    
        setCookie("news_edit_title",$("#News_title").val());
        setCookie("news_edit_content",$("#News_content").val());
        setCookie("news_edit_attachment1_checkbox_for_deleting",$("#News_attachment1_checkbox_for_deleting").val());
        setCookie("news_edit_attachment2_checkbox_for_deleting",$("#News_attachment2_checkbox_for_deleting").val());
        setCookie("news_edit_attachment3_checkbox_for_deleting",$("#News_attachment3_checkbox_for_deleting").val());        
        $("body").attr('id','admin');         
    });
</script>