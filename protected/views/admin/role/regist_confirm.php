            ...
            <div class="mainBox detail">
                ...
                <div class="form-horizontal">
                	...
                	<div class="control-group">
                        ...
                        <div class="controls">
                        	<p class="mt5">
                                <input  name="role_name" type="hidden" value="<?php echo htmlspecialchars($roles['role_name']) ?>"/>
                    ...
                    <div class="control-group">
                        <div class="control-label"><?php echo htmlspecialchars($val['function_name']) ?>&nbsp;</div>
                        <div class="controls">
                        	<div>
                ...
                <div class="form-last-btn">
                    <div class="btn170">
                        <button type="submit" class="btn" onclick="history.back();"><i class="icon-chevron-left"></i> <?php echo Config::TEXT_FOR_BACK_IN_PAGE_CONFIRM;?></button>
                        <button type="submit" id="submit" class="btn btn-important"><i class="icon-chevron-right icon-white"></i> <?php echo Config::TEXT_FOR_CONFIRM_IN_PAGE_REGIST_CONFIRM;?></button>
                    </div>
                </div>
