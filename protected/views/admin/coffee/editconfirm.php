...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/admincoffee/editconfirm') ; 
            ...
            <div class="mainBox detail">
                ...
                <div class="box">
						...
						$form = $this->beginWidget('CActiveForm', array(
							'id' => 'coffee_form',
							'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/admincoffee/editconfirm'),
								));
						?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->editConfirm11($model, $form,'admincoffee',Yii::app()->request->baseUrl);
                            $this->endWidget();
                            ?>
                        </div>
                    </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) {  
        ...
        $(window).on('beforeunload', function(){
            setCookie("coffee_edit_from","confirm");            
        }); 
        ...
        $('button#back').click(function(){ 
            setCookie("coffee_edit_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/admincoffee/edit/?id=<?php echo $model->id;?>";
        });
        $('a').click(function(){  
            if($(this).attr('id')==undefined||$(this).attr('id')=='bttop'){
                return;
            }
			 window.location="<?php echo Yii::app()->baseUrl;?>/admincoffee/download/?file_name="+$(this).attr('id');
        });
       
	    
        setCookie("coffee_edit_title",$("#Coffee_title").val());
        setCookie("coffee_edit_content",$("#Coffee_content").val());
        setCookie("coffee_edit_attachment1_checkbox_for_deleting",$("#Coffee_attachment1_checkbox_for_deleting").val());
        setCookie("coffee_edit_attachment2_checkbox_for_deleting",$("#Coffee_attachment2_checkbox_for_deleting").val());
        setCookie("coffee_edit_attachment3_checkbox_for_deleting",$("#Coffee_attachment3_checkbox_for_deleting").val());        
        $("body").attr('id','admin');         
    });
</script>