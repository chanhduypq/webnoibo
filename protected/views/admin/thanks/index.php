        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>
            <div class="mainBox detail">
            	<div class="pageTtl"><h2></h2>                    
                    <a class="btn btn-important" href="<?php echo Yii::app()->baseUrl;?>/adminthanks/regist"><i class="icon-pencil icon-white"></i> <?php echo Config::TEXT_FOR_ADD_IN_PAGE_INDEX;?></a>
                    <a onclick="if(confirm('<?php echo Config::TEXT_FOR_CONFIRM_DELETE;?>')) window.location='<?php echo Yii::app()->baseUrl;?>/adminthanks/deleteall';" class="btn btn-work" href="#"><i class="icon-trash icon-white"></i> Xóa tất cả</a>
            	</div>
                <div class="box">
                ...
                <table width="724" border="0" class="table list font14">
                	<thead>
                            <tr>
                            <th class="td-target">Thành viên</th>
                            <th class="td-comment">Nội dung</th>
                    ...
                    if(isset($thanks)&&is_array($thanks)&&count($thanks)>0){
                        foreach ($thanks as $thank){
	                        ...
	                        <td class="td-comment">
	                        	<?php echo nl2br(htmlspecialchars($thank['comment']));?>
	                        </td>
	                        <td class="td-edit"><a class="btn btn-work" href="<?php echo Yii::app()->baseUrl; ?>/adminthanks/edit/?id=<?php echo $thank['id'];?>"><?php echo Config::TEXT_FOR_EDIT_IN_PAGE_ADMIN_INDEX;?></a><a onclick="if(confirm('<?php echo Config::TEXT_FOR_CONFIRM_DELETE;?>')==true) window.location='<?php echo Yii::app()->request->baseUrl; ?>/adminthanks/delete/?id=<?php echo $thank['id']; ?>'" href="#" class="btn btn-correct"><?php echo Config::TEXT_FOR_DELETE_IN_PAGE_ADMIN_INDEX;?></a></td>
	                    </tr>
