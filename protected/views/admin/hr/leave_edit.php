            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminhr/leave<?php echo $page;?>">
...
<script type="text/javascript"> 
        jQuery(function($){ 
            position1=getCookie("hr_leave_edit_position");
				...
				success: function(msg){	 
                                    ...
                                    for (i = 0,n=users.length; i <n; i++) {
                                        ...
                                        if(position1==users[i].id){
                                            jQuery('#Leave_position').append("<option selected='selected' value=" + users[i].id + ">" + users[i].post_name + "</option>");
                                        }
                                        else{
          ...
          $("#hr_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminhr/leave_editconfirm/');       	   
		 
		      
           title=getCookie("hr_leave_edit_member_name");
           if(title!=null&&title!="null"){
               $("#Leave_member_name").val(title);
           }
           leave_date=getCookie("hr_leave_edit_leave_date");
           ...
           detail=getCookie("hr_leave_edit_detail");           
           if(detail!=null&&detail!="null"){
                detail1=detail.replace(/<br ?\/?>|_/g, '\n');
               $("#Leave_detail").val(detail1);
           }
           division=getCookie("hr_leave_edit_unit");
           if(division!=null&&division!="null"){
           $("#Leave_unit").val(division);
           position=getCookie("hr_leave_edit_position");
           $.ajax({    
				type: "POST", 
				async:true,
           ...
           setCookie("hr_leave_edit_detail",detail); 
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminhr/leave_edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	           
					  ...
					  jQuery('#Leave_detail').prev().remove();       
					  	...
					  	if(msg!='[]'){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("hr_leave_edit_detail",val);
