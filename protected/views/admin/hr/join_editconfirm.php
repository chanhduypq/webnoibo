        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>         
            <div class="mainBox detail">
				...
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'hr_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/workhr/join_editconfirm'),
						));
				?> 
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie("hr_join_edit_from","confirm");            
        }); 
		
        
        
        setCookie("hr_join_edit_member_name",$("#Join_member_name").val()); 
        setCookie("hr_join_edit_detail",$("#Join_detail").val());
       ...
       setCookie("hr_join_edit_join_date",$("#Join_join_date").val());
        ...
        $('button#back').click(function(){  
            ...
            setCookie("hr_join_edit_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/adminhr/join_edit/?id=<?php echo $model->id;?>";
        });
