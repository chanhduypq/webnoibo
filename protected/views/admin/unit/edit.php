...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminunit/edit') ; 
                ...
                <div class="box">
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
							...
							$attachements->edit11($model, $form,'adminunit',$attachment1_error,$attachment2_error,$attachment3_error,Yii::app()->request->baseUrl);                        
							$this->endWidget();
                           		 ?>
...
<script type="text/javascript"> 
        ...
        jQuery(function($){
         ...
         $("#unit_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminunit/editconfirm/');        
            
			//check back browser 
		   
		   
		   
		   unit_name=getCookie("unit_edit_unit_name");
           ...
           unit_mailaddr=getCookie("unit_edit_mailaddr");
           ...
           unit_catchphrase=getCookie("unit_edit_catchphrase");
           if(unit_catchphrase!=null&&unit_catchphrase!="null"){
               $("#Unit_catchphrase").val(unit_catchphrase);
           }
		    unit_introduction=getCookie("unit_edit_introduction");           
           if(unit_introduction!=null&&unit_introduction!="null"){
		    ...
		    attachment1_checkbox_for_deleting=getCookie("unit_edit_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("unit_edit_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("unit_edit_attachment3_checkbox_for_deleting");
           ...
           $('button[type="submit"]').click(function(){ 
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminunit/edit/?id=<?php echo $model->id?>",    
				...
				{	     
					  ...
					  {   
                           ...
                           setCookie("unit_edit_unit_name",$("#Unit_unit_name").val());
                           setCookie("unit_edit_mailaddr",$("#Unit_mailaddr").val());
                           
						   setCookie("unit_edit_catchphrase",$("#Unit_catchphrase").val());
						   val=$("#Unit_introduction").val();
						   val=val.replace(/\n/g, "<br/>");
						   setCookie("unit_edit_introduction",val);
                                                               
							if($("#Unit_attachment1_checkbox_for_deleting").is(':checked')){
                                                           
								setCookie("unit_edit_attachment1_checkbox_for_deleting",'1');
							}
							else{
								setCookie("unit_edit_attachment1_checkbox_for_deleting",'0');
							}
							if($("#Unit_attachment2_checkbox_for_deleting").is(':checked')){
								setCookie("unit_edit_attachment2_checkbox_for_deleting",'1');
							}
							else{
								setCookie("unit_edit_attachment2_checkbox_for_deleting",'0');
							}
							if($("#Unit_attachment3_checkbox_for_deleting").is(':checked')){
								setCookie("unit_edit_attachment3_checkbox_for_deleting",'1');
							}
							else{
								setCookie("unit_edit_attachment3_checkbox_for_deleting",'0');
							}
