...
<div class="wrapper secondary admin"> 
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_EDIT_IN_LINK_BACK_DIV,"link"=>'/adminunit/editconfirm') ; 
            ...
            <div class="mainBox">
                ...
                <div class="box">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        'id' => 'unit_form',
                        'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/adminunit/editconfirm'),
                    ));
                    ?>
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                                 <?php                    
                                    ...
                                    $attachements->editConfirm11($model, $form,'adminunit',Yii::app()->request->baseUrl);
									$this->endWidget();
                           		 ?>
    ...
    jQuery(function($) {
        ...
        $('button#back').click(function() {
            ...
            setCookie("unit_edit_from", "confirm");
             ...
             window.location="<?php echo Yii::app()->baseUrl;?>/adminunit/edit/?id=<?php echo $model->id;?>";
        });
        $('a').click(function() {
