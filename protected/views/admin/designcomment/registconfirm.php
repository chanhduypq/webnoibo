...
<div class="wrapper secondary admin">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/admindesigncomment/registconfirm') ; 
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>            
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>今日のありがとう - 登録 確認</h2></div>
                <div class="box">
                      <?php
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $('button#back').click(function(){         
            window.location="<?php echo Yii::app()->baseUrl;?>/admindesigncomment/regist/";
        }); 
    });
</script>
