            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/playcoffee/<?php echo $page;?>">
                ...
                <div class="cnt-box">     
                    ...
                    <div class="field attachements">
						...
						$attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'playcoffee',Yii::app()->request->baseUrl);
                        $this->endWidget();
                    ?>
                      </div>
                </div><!-- /cnt-box -->
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
          ...
          $("#coffee_form").attr('action','<?php echo Yii::app()->baseUrl;?>/playcoffee/registconfirm/');       	   
		 
		      
           title=getCookie("coffee_regist_title");
           ...
           content=getCookie("coffee_regist_content");           
           if(content!=null&&content!="null"){
                content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Coffee_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("coffee_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("coffee_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("coffee_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("coffee_regist_content",content); 
           $('a').click(function(){ 
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/playcoffee/regist/",    
				...
				success: function(msg){	           
					  ...
					  jQuery('#Coffee_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("coffee_regist_content",val);
                                                if($("#Coffee_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("coffee_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("coffee_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Coffee_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("coffee_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("coffee_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Coffee_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("coffee_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("coffee_regist_attachment3_checkbox_for_deleting",'0');
                                                }
