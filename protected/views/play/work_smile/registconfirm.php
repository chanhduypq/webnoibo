...
<div class="wrapper secondary">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/playwork_smile/registconfirm') ; 
            ...
            <div class="mainBox detail">
                ...
                <div class="cnt-box">
					...
					<div class="field attachements">
                      ...
                      <?php $attachements->regist_confirm_one_file_img($model, $form,'playwork_smile',Yii::app()->request->baseUrl);?>
                      <?php $this->endWidget();?>
                    </div>	
                </div><!-- /cnt-box -->	
                             <?php $this->endWidget(); ?> 
...
<script type="text/javascript">
	...
	jQuery(function($) 
	{
		...
		{
			setCookie("work_smile_regist_form","confirm");            
			// $.ajax
			// ({    
				// type: "GET", 
				// async:false,
		...
		setCookie("work_smile_reg_content",$("#Work_smile_content").val());
        setCookie("work_smile_reg_attachment1_checkbox_for_deleting",$("#Work_smile_attachment1_checkbox_for_deleting").val());
		...
		{  
            ...
            // $.ajax({    
                    ...
                    // url: getUrl(1)
            // });
            window.location="<?php echo Yii::app()->baseUrl;?>/playwork_smile/regist";
        });
