            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/playnews/<?php echo $page;?>">
                ...
                <div class="cnt-box">     
                    ...
                    <div class="field attachements">
						...
						$attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'playnews',Yii::app()->request->baseUrl);
                        $this->endWidget();
                    ?>
                      </div>
                </div><!-- /cnt-box -->
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
          ...
          $("#news_form").attr('action','<?php echo Yii::app()->baseUrl;?>/playnews/registconfirm/');       	   
		 
		      
           title=getCookie("news_regist_title");
           ...
           content=getCookie("news_regist_content");           
           if(content!=null&&content!="null"){
                content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#News_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("news_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("news_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("news_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("news_regist_content",content); 
           $('a').click(function(){ 
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				...
				url: "<?php echo Yii::app()->baseUrl;?>/playnews/regist/",   
				success: function(msg){	          
					  ...
					  jQuery('#News_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("news_regist_content",val);
                                                if($("#News_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("news_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("news_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#News_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("news_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("news_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#News_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("news_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("news_regist_attachment3_checkbox_for_deleting",'0');
                                                }
