        ...
        ?>
            <div class="pageTtl1"><h2></h2>
                    ...
                    <?php if (FunctionCommon::isPostFunction("ideas") == true) {
                        ?>
                        <a href="<?php echo Yii::app()->baseUrl ?>/workideas/regist" class="btn btn-important"><i class="icon-pencil icon-white"></i> <?php echo Config::TEXT_FOR_ADD_IN_PAGE_INDEX;?></a>
                    <?php } ?>
                </div>
            <div class="box_left">
            	<h2 class="skyblue">
                ...
                <div class="list_no_images">
                	<ul>
                        ...
                        <div class="txt_no_images">
                            <?php echo CHtml::link(htmlspecialchars($item->title), array('workideas/detail', 'id' => $item->id)); ?>
                            ...
                            <p style="word-wrap: break-word;"><?php
                                        ...
                                        ?></p>                            
                            <a class="more" href="<?php echo Yii::app()->request->baseUrl.'/workideas/detail?id='.$item->id;?>">Xem thêm</a>
                        </div>
                        <div class="clear"></div>
                    </li>
                            <?php
