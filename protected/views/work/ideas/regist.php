            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/workideas/<?php echo $page;?>">
                ...
                <div class="cnt-box">     
                    ...
                    <div class="field attachements">
						...
						$attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'workideas',Yii::app()->request->baseUrl);
                        $this->endWidget();
                    ?>
                      </div>
                </div><!-- /cnt-box -->
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
          ...
          $("#ideas_form").attr('action','<?php echo Yii::app()->baseUrl;?>/workideas/registconfirm/');       	   
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/workideas/regist/",    
