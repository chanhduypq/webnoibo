        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>             
            <div class="mainBox detail">
				...
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'itcontest_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/workitcontest/registconfirm'),
						));
				?> 
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
						  ...
						  <?php $attachements->registConfirm11($model, $form,'workitcontest',Yii::app()->request->baseUrl);?>
						  <?php $this->endWidget();?>
                	  </div>
                </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie("itcontest_regist_from","confirm");            
        }); 
		
        setCookie("itcontest_regist_title",$("#Itcontest_title").val());
        setCookie("itcontest_regist_content",$("#Itcontest_content").val());
        setCookie("itcontest_regist_attachment1_checkbox_for_deleting",$("#Itcontest_attachment1_checkbox_for_deleting").val());
        setCookie("itcontest_regist_attachment2_checkbox_for_deleting",$("#Itcontest_attachment2_checkbox_for_deleting").val());
        setCookie("itcontest_regist_attachment3_checkbox_for_deleting",$("#Itcontest_attachment3_checkbox_for_deleting").val());
        ...
        $('button#back').click(function(){  
            ...
            setCookie("itcontest_regist_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/workitcontest/regist/";
        });
       $('a').click(function(){  
