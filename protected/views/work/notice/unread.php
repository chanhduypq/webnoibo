    ...
    <div class="content_left">
        ...
        ?>
            <div class="pageTtl1"><h2></h2>
                    ...
                    <?php if (FunctionCommon::isPostFunction("notice") == true) {
                        ?>
                        <a href="<?php echo Yii::app()->baseUrl ?>/worknotice/regist" class="btn btn-important"><i class="icon-pencil icon-white"></i> <?php echo Config::TEXT_FOR_ADD_IN_PAGE_INDEX;?></a>
                    <?php } ?>
                ...
                <div class="list_no_images">
                	<ul>
                        ...
                        <div class="txt_no_images">
                            <?php echo CHtml::link(htmlspecialchars($item->title), array('worknotice/detail_unread', 'id' => $item->id)); ?>
                            ...
                            <p style="word-wrap: break-word;"><?php
                                        ...
                                        ?></p>                            
                            <a class="more" href="<?php echo Yii::app()->request->baseUrl.'/worknotice/detail_unread?id='.$item->id;?>">Xem thêm</a>
                        </div>
                        <div class="clear"></div>
                    </li>
                            <?php
