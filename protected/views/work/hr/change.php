        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>
            <div class="pageTtl1"><h2></h2>
                    ...
                    <?php if (FunctionCommon::isPostFunction("hr") == true) {
                        ?>
                        <a href="<?php echo Yii::app()->baseUrl ?>/workhr/change_regist" class="btn btn-important"><i class="icon-pencil icon-white"></i> <?php echo Config::TEXT_FOR_ADD_IN_PAGE_INDEX;?></a>
                        <a href="<?php echo Yii::app()->baseUrl ?>/workhr/" class="btn btn-important"><i class="icon-white"></i> Thông báo từ phòng hành chính nhân sự</a>
                ...
                <div class="list_no_images">
                	<ul>
                        ...
                        <div class="txt_no_images">
                            ...
                            echo CHtml::link(htmlspecialchars($item->member_name), array('workhr/change_detail', 'id' => $item->id)); ?>
                            
                            <span class="time"><?php echo FunctionCommon::formatDate($item->created_date); ?></span>
                            <p style="word-wrap: break-word;"><?php
                                        $content = nl2br($item->detail);
                                        ...
                                        ?></p>                            
                            <a class="more" href="<?php echo Yii::app()->request->baseUrl.'/workhr/change_detail?id='.$item->id;?>">Xem thêm</a>
                        </div>
                        <div class="clear"></div>
                    </li>
                            <?php
