        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>            
            <div class="mainBox detail">
				...
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'hr_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/workhr/change_registconfirm'),
						));
				?> 
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie("hr_change_regist_from","confirm");            
        }); 
		
        
        
        setCookie("hr_change_regist_member_name",$("#Change_member_name").val()); 
        setCookie("hr_change_regist_detail",$("#Change_detail").val());
       ...
       setCookie("hr_change_regist_change_date",$("#Change_change_date").val());
        ...
        $('button#back').click(function(){  
            ...
            setCookie("hr_change_regist_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/workhr/change_regist/";
        });
