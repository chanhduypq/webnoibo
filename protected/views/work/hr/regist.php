...
<?php
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/workhr/regist') ; 
            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/workhr/<?php echo $page;?>">
                ...
                <div class="cnt-box">     
                    ...
                    <div class="field attachements">
						...
						$attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'workhr',Yii::app()->request->baseUrl);
                        $this->endWidget();
                    ?>
                      </div>
                </div><!-- /cnt-box -->
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
          ...
          $("#hr_form").attr('action','<?php echo Yii::app()->baseUrl;?>/workhr/registconfirm/');       	   
		 
		      
           title=getCookie("hr_regist_title");
           ...
           content=getCookie("hr_regist_content");           
           if(content!=null&&content!="null"){
                content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Hr_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("hr_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("hr_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("hr_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("hr_regist_title",$("#Hr_title").val());
           setCookie("hr_regist_content",content); 
           $('a').click(function(){ 
            ...
            window.location="<?php echo Yii::app()->baseUrl;?>/workhr/download/?file_name="+$(this).attr('id');
        });
            /**
             * 
             */
           ...
           $('button[type="submit"]').click(function(){  
            ...
            deleteCookies("hr_regist_from"); 		   
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/workhr/regist/",    
				...
				success: function(msg){	           
					  ...
					  jQuery('#Hr_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=$("#Hr_content").val();
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("hr_regist_content",val);
                                                if($("#Hr_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hr_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hr_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Hr_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hr_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hr_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Hr_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hr_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hr_regist_attachment3_checkbox_for_deleting",'0');
                                                }
