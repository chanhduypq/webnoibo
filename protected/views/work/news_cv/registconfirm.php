        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>             
            <div class="mainBox detail">
				...
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'news_cv_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/worknews_cv/registconfirm'),
						));
				?> 
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
						  ...
						  <?php $attachements->registConfirm11($model, $form,'worknews_cv',Yii::app()->request->baseUrl);?>
						  <?php $this->endWidget();?>
                	  </div>
                </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie("news_cv_regist_from","confirm");            
        }); 
		
        setCookie("news_cv_regist_title",$("#News_cv_title").val());
        setCookie("news_cv_regist_content",$("#News_cv_content").val());
        setCookie("news_cv_regist_attachment1_checkbox_for_deleting",$("#News_cv_attachment1_checkbox_for_deleting").val());
        setCookie("news_cv_regist_attachment2_checkbox_for_deleting",$("#News_cv_attachment2_checkbox_for_deleting").val());
        setCookie("news_cv_regist_attachment3_checkbox_for_deleting",$("#News_cv_attachment3_checkbox_for_deleting").val());
        ...
        $('button#back').click(function(){  
            ...
            setCookie("news_cv_regist_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/worknews_cv/regist/";
        });
       $('a').click(function(){  
