                ...
                <div class="list_no_images">
                	<ul>
                        ...
                        <div class="txt_no_images">
                            <?php echo CHtml::link(htmlspecialchars($item->title), array('worknews_cv/detail', 'id' => $item->id)); ?>
                            ...
                            <p style="word-wrap: break-word;"><?php
                                        ...
                                        ?></p>                            
                            <a class="more" href="<?php echo Yii::app()->request->baseUrl.'/worknews_cv/detail?id='.$item->id;?>">Xem thêm</a>
                        </div>
                        <div class="clear"></div>
                    </li>
                            <?php
