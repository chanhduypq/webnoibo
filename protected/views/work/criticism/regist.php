...
<?php
        	$home_link='/work';
        $link_array=array();
        $link_array[]=array("text"=>"Các văn bản & quyết định","link"=>'/workcriticism') ; 
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/workcriticism/regist') ; 
            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/workcriticism/<?php echo $page;?>">
                ...
                <div class="cnt-box">     
                    ...
                    <div class="field attachements">
						...
						$attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'workcriticism',Yii::app()->request->baseUrl);
                        $this->endWidget();
                    ?>
                      </div>
                </div><!-- /cnt-box -->
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
          ...
          $("#criticism_form").attr('action','<?php echo Yii::app()->baseUrl;?>/workcriticism/registconfirm/');       	   
		 
		      
           title=getCookie("criticism_regist_title");
           ...
           content=getCookie("criticism_regist_content");           
           if(content!=null&&content!="null"){
                content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Criticism_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("criticism_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("criticism_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("criticism_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("criticism_regist_title",$("#Criticism_title").val());
           setCookie("criticism_regist_content",content); 
           $('a').click(function(){ 
            ...
            window.location="<?php echo Yii::app()->baseUrl;?>/workcriticism/download/?file_name="+$(this).attr('id');
        });
            /**
             * 
             */
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/workcriticism/regist/",    
				...
				success: function(msg){	           
					  ...
					  jQuery('#Criticism_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("criticism_regist_content",val);
                                                if($("#Criticism_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("criticism_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("criticism_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Criticism_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("criticism_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("criticism_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Criticism_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("criticism_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("criticism_regist_attachment3_checkbox_for_deleting",'0');
                                                }
