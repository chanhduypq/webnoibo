        ...
        ?>
            <div class="pageTtl1"><h2></h2>
                    ...
                    <?php if (FunctionCommon::isPostFunction("criticism") == true) {
                        ?>
                        <a href="<?php echo Yii::app()->baseUrl ?>/workcriticism/regist" class="btn btn-important"><i class="icon-pencil icon-white"></i> <?php echo Config::TEXT_FOR_ADD_IN_PAGE_INDEX;?></a>
                    <?php } ?>
                </div>
            <div class="box_left">
            	<h2 class="skyblue">
                ...
                <div class="list_no_images">
                	<ul>
                        ...
                        <div class="txt_no_images">
                            ...
                            <?php 
                            $icon= FunctionCommon::get_icon_for_criticism($item->attachment1, $item->attachment2, $item->attachment3);
                            if($icon!=""){
                                echo "<span class='$icon'>&nbsp;</span>";
                            }
                            echo CHtml::link(htmlspecialchars($item->title), array('workcriticism/detail', 'id' => $item->id)); ?>
                            ...
                            <p style="word-wrap: break-word;"><?php
                                        ...
                                        ?></p>                            
                            <a class="more" href="<?php echo Yii::app()->request->baseUrl.'/workcriticism/detail?id='.$item->id;?>">Xem thêm</a>
                        </div>
                        <div class="clear"></div>
                    </li>
                            <?php
