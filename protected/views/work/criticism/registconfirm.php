        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>             
            <div class="mainBox detail">
				...
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'criticism_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/workcriticism/registconfirm'),
						));
				?> 
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
						  ...
						  <?php $attachements->registConfirm11($model, $form,'workcriticism',Yii::app()->request->baseUrl);?>
						  <?php $this->endWidget();?>
                	  </div>
                </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie("criticism_regist_from","confirm");            
        }); 
		
        setCookie("criticism_regist_title",$("#Criticism_title").val());
        setCookie("criticism_regist_content",$("#Criticism_content").val());
        setCookie("criticism_regist_attachment1_checkbox_for_deleting",$("#Criticism_attachment1_checkbox_for_deleting").val());
        setCookie("criticism_regist_attachment2_checkbox_for_deleting",$("#Criticism_attachment2_checkbox_for_deleting").val());
        setCookie("criticism_regist_attachment3_checkbox_for_deleting",$("#Criticism_attachment3_checkbox_for_deleting").val());
        ...
        $('button#back').click(function(){  
            ...
            setCookie("criticism_regist_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/workcriticism/regist/";
        });
       $('a').click(function(){  
