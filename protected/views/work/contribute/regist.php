...
<?php
        	$home_link='/work';
        $link_array=array();
        $link_array[]=array("text"=>"Hòm thư góp ý","link"=>'/workcontribute') ; 
        $link_array[]=array("text"=>  Config::TEXT_FOR_ADD_IN_LINK_BACK_DIV,"link"=>'/workcontribute/regist') ; 
            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <span>
                        ...
                        ?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/workcontribute/<?php echo $page;?>">
                ...
                <div class="cnt-box">     
                    ...
                    <div class="field attachements">
						...
						$attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'workcontribute',Yii::app()->request->baseUrl);
                        $this->endWidget();
                    ?>
                      </div>
                </div><!-- /cnt-box -->
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
          ...
          $("#contribute_form").attr('action','<?php echo Yii::app()->baseUrl;?>/workcontribute/registconfirm/');       	   
		 
		      
           title=getCookie("contribute_regist_title");
           ...
           content=getCookie("contribute_regist_content");           
           if(content!=null&&content!="null"){
                content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Contribute_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("contribute_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("contribute_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("contribute_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("contribute_regist_title",$("#Contribute_title").val());
           setCookie("contribute_regist_content",content); 
           $('a').click(function(){ 
            ...
            window.location="<?php echo Yii::app()->baseUrl;?>/workcontribute/download/?file_name="+$(this).attr('id');
        });
            /**
             * 
             */
           ...
           $('button[type="submit"]').click(function(){  
            ...
            deleteCookies("contribute_regist_from"); 		   
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/workcontribute/regist/",    
				...
				success: function(msg){	           
					  ...
					  jQuery('#Contribute_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("contribute_regist_content",val);
                                                if($("#Contribute_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("contribute_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("contribute_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Contribute_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("contribute_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("contribute_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Contribute_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("contribute_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("contribute_regist_attachment3_checkbox_for_deleting",'0');
                                                }
