...
<div class="wrapper secondary">
        ...
        $link_array[]=array("text"=>  Config::TEXT_FOR_DETAIL_IN_LINK_BACK_DIV,"link"=>'/workcontribute/detail') ; 
        ...
        ?>
            <div class="mainBox detail">
            	<div class="pageTtl">
                 ...
                 <span>
					<?php if(Yii::app()->request->cookies['page'] != NULL): ?>	
						<a href="<?php echo Yii::app()->request->baseUrl; ?>/workcontribute/index?page=<?php echo Yii::app()->request->cookies['page']?>" class="btn btn-important">
							<i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?>
						</a>
					<?php else : ?>
						<a href="<?php echo Yii::app()->request->baseUrl; ?>/workcontribute" class="btn btn-important">
							<i class="icon-chevron-left icon-white"></i> <?php echo Config::TEXT_FOR_BACK_TO_LIST;?>
						</a>
					<?php endif; ?>
				</span>
				...
				<?php if(!is_null($model)): ?>	
                    ...
                    $attachements->detail($model, 'admincontribute',Yii::app()->request->baseUrl,$edit=true);                        
                    $this->endWidget();
                    ?>                
                <?php endif; ?>
                </div>
