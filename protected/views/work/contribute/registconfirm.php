        ...
        $this->widget('Path_actionwidget', array('home_link'=>$home_link,'link_array'=>$link_array)); ?>             
            <div class="mainBox detail">
				...
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'contribute_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/workcontribute/registconfirm'),
						));
				?> 
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
						  ...
						  <?php $attachements->registConfirm11($model, $form,'workcontribute',Yii::app()->request->baseUrl);?>
						  <?php $this->endWidget();?>
                	  </div>
                </div><!-- /cnt-box -->	
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie("contribute_regist_from","confirm");            
        }); 
		
        setCookie("contribute_regist_title",$("#Contribute_title").val());
        setCookie("contribute_regist_content",$("#Contribute_content").val());
        setCookie("contribute_regist_attachment1_checkbox_for_deleting",$("#Contribute_attachment1_checkbox_for_deleting").val());
        setCookie("contribute_regist_attachment2_checkbox_for_deleting",$("#Contribute_attachment2_checkbox_for_deleting").val());
        setCookie("contribute_regist_attachment3_checkbox_for_deleting",$("#Contribute_attachment3_checkbox_for_deleting").val());
        ...
        $('button#back').click(function(){  
            ...
            setCookie("contribute_regist_from","confirm");   
            window.location="<?php echo Yii::app()->baseUrl;?>/workcontribute/regist/";
        });
       $('a').click(function(){  
